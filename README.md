...
| [credential-manager](https://clawskills.sh/skills/callmedas69-credential-manager) | — | — | — | Unified credential management, enforce security baseline |
| [arc-skill-scanner](https://clawskills.sh/skills/trypto1019-arc-skill-scanner) | — | — | — | Auto-scan skills for vulnerabilities before install |
| [agentaudit](https://clawskills.sh/skills/starbuck100-agentaudit) | — | — | — | Check vulnerability databases before package install |
...
| [fractal-memory](https://clawskills.sh/skills/bugmaker2-fractal-memory) | — | — | — | Hierarchical compression — prevent context overflow |
| [arc-wake-state](https://clawskills.sh/skills/trypto1019-arc-wake-state) | — | — | — | Auto-recover agent state after crash/restart |
| [agent-wal](https://clawskills.sh/skills/bowen31337-agent-wal) | — | — | — | Write-Ahead Log — atomic state change guarantees |
...
| [agent-mode-upgrades](https://clawskills.sh/skills/maverick-software-agent-mode-upgrades) | — | — | — | Persistent state + auto-planning + pre-execution approval |
| [debug-methodology](https://clawskills.sh/skills/abczsl520-debug-methodology) | — | — | — | Systematic debugging — block patch chains and workarounds |
...
| [alex-session-wrap-up](https://clawskills.sh/skills/xbillwatsonx-alex-session-wrap-up) | — | — | — | Auto-commit + extract learnings + persist rules |
| [buildlog](https://clawskills.sh/skills/espetey-buildlog) | — | — | — | Replayable coding session log for auditing |
| [buffer-session](https://clawskills.sh/skills/waynevaughan-buffer-session) | — | — | — | Native session switching with state buffering |
...
| [pyright-lsp](https://clawskills.sh/skills/bowen31337-pyright-lsp) | — | — | — | Python language server — static type checking |
| [astrai-code-review](https://clawskills.sh/skills/beee003-astrai-code-review) | — | — | — | AI code review + smart model routing, save 40%+ cost |
| [cacheforge-vibe-check](https://clawskills.sh/skills/tkuehnl-cacheforge-vibe-check) | — | — | — | Detect AI-generated code quality issues |
| [docsync](https://clawskills.sh/skills/suhteevah-docsync) | — | — | — | Auto-generate docs from code, detect doc drift |
...
| [agentic-devops](https://clawskills.sh/skills/tkuehnl-agentic-devops) | — | — | — | Docker + process management + log analysis + health monitoring |
| [sentry-observability](https://clawskills.sh/skills/sergical-sentry-observability) | — | — | — | Error/log/traces integration with Sentry |
| [arc-metrics-dashboard](https://clawskills.sh/skills/trypto1019-arc-metrics-dashboard) | — | — | — | Agent call volume, error rate, latency, cost visualization |
| [cicd-pipeline](https://clawskills.sh/skills/gitgoodordietrying-cicd-pipeline) | — | — | — | Manage GitHub Actions CI/CD pipelines directly |
...
| [docs-feeder](https://clawskills.sh/skills/zerone0x-docs-feeder) | — | — | — | Auto-fetch project docs and feed to agent |
